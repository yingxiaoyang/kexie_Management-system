...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'project-changes', name: 'owner-project-changes', component: () => import('../views/owner/OwnerProjectChanges.vue'), meta: { title: '项目变更申请' } },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'project-changes', name: 'admin-project-changes', component: () => import('../views/admin/AdminProjectChanges.vue'), meta: { title: '项目变更审批', permission: 'material_review' } },
